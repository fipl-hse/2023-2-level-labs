...
from lab_3_generate_by_ngrams.main import NGramLanguageModel, GreedyTextGenerator, BeamSearchTextGenerator
from lab_4_fill_words_by_ngrams.main import TopPGenerator, WordProcessor, GeneratorTypes, QualityChecker
