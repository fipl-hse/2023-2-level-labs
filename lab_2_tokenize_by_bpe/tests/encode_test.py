...
class EncodeTest(unittest.TestCase):
    ...
    def test_encode_ideal(self):
        ...
        """
        expected = [144, 179, 95, 171, 79, 21,  # 178, 34
                    171, 176, 181, 169, 28,  # 190, 34
                    179, 89, 72, 200, 7,  # 73, 34
                    0, 25,  # 186, 34
                    55, 68, 4,  # 60, 34,
                    96, 72, 179, 24,
                    # [96, 72, 67, 34] -> [96, 72, 179, 24] - только: то | ль | ко | </s> или то | ль | к | о</s>
                    184, 185, 20,  # [40, 34] -> [184, 185, 20] - при: при | </s> или п | р | и</s>
                    171, 176, 180, 60, 174, 14,  # 104, 34,
                    83, 68, 172, 169, 200, 186, 30,  # 197, 34,
                    54, 69, 19,  # 174, 34,
                    8,  # 75, 34,
                    91, 180, 27,  # 188, 34,
                    20,  # 177, 34,
                    75, 184, 84, 171, 180, 37, 19,  # 174, 34,
                    171, 60, 84, 15]  # 106, 34
    ...
    def test_encode_with_unk(self):
        ...
        """
        expected = [158, 81, 34,
                    171, 70, 200, 77, 174, 23,  # 181, 34,
                    180, 47, 63, 43, 3,  # 53, 34,
                    129, 134, 16, 16, 139, 34,
                    101, 142, 170, 174, 180, 196, 178, 143, 102, 34,
                    129, 134, 130, 129, 140, 138, 129, 16, 34,
                    192, 188, 187, 30,  # 197, 34,
                    83, 176, 173, 76, 19,  # 174, 34,
                    184, 85, 171, 185, 47, 177, 180, 11,  # 186, 200, 34 -> 11: ся</s> вместо с|я|</s>
                    18,  # 171, 34,
                    129, 134, 16, 129, 140, 138, 137, 139, 139, 15,  # 106, 34
                    ]
