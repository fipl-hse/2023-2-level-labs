...
"""
from lab_1_classify_by_unigrams.main import create_language_profile, collect_profiles, detect_language_advanced, \
    print_report
...
def main() -> None:
    ...
    language_profiles = ['assets/profiles/es.json', 'assets/profiles/de.json', 'assets/profiles/en.json',
