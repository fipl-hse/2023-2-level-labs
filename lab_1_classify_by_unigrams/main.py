...
def compare_profiles(
    ...
    if not isinstance(unknown_profile, dict) or not isinstance(profile_to_compare, dict):
        return None
    if not "name" in unknown_profile.keys() or "name" in profile_to_compare.keys() or "freq" not in unknown_profile.keys() or "freq" not in profile_to_compare.keys():
        return None
    return calculate_mse(unknown_profile["freq"], profile_to_compare["freq"])
